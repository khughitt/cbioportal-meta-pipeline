---
id: "synthesis:2026-06-06-cancer-neuroscience"
type: "synthesis"
title: "Cancer neuroscience literature batch (21 papers): does it explain a neural-gene mutation signal?"
status: "active"
ontology_terms:
  - cancer neuroscience
...
1. **Mechanism is expression / innervation / paracrine / epigenetic — not mutation.** Every
   ...
   `paper:Hanahan2023`, `paper:Wang2025`) frames neural regulation of cancer as nerves
...
3. **The candidate genes share the gene-length-confound profile.** LSAMP, OPCML, NKAIN2,
   ...
   mutation (`hypothesis:h03`, `question:q031` on TTN-like residual signal). `paper:Lu2026`'s
...
- **Questions:** `question:q032`–`question:q037` (length null, CNS exclusion, NET exclusion,

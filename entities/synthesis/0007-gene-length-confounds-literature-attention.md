...
created: '2026-06-02'
updated: '2026-06-02'
id: synthesis:0007-gene-length-confounds-literature-attention
...
hypothesis:0003-gene-length-confounds-literature-attention is at proposed/active status. The core
...
The motivating structural prerequisite is established. interpretation:0009-t131-full-pan-cancer-dndscv-run
...
(interpretation:0009-t131-full-pan-cancer-dndscv-run, F4).
...
- task:t129 (P2) — partial-slope regression; blocked on F4 pooled-mean fix and assay-stratum
  handling per interpretation:0015-q016-panel-induced-ascertainment.
...
- question:0011-gene-length-as-literature-attention-confounder — primary formal question; task:t129
  is the decisive test.
- question:0016-panel-induced-ascertainment — partially addressed by
  interpretation:0015-q016-panel-induced-ascertainment; panel signal conflates assay,

...
paper:Jiang2025a demonstrates that consensus calling (≥2 callers) is essential for artifact-free
...
By contrast, paper:Islam2022 and paper:Jiang2025a both document that de novo extraction and
...
8. The minimum mutation count for stable per-sample SBS-96 profile is ~383 mutations for WES
   (paper:Jiang2025a), 64–323 depending on matched-normal availability (paper:Battuello2024).
...
- Transformer-based approaches (paper:Zhang2026a, SigFormer) have not been peer-reviewed and
...
|---|---|---|
| SBS7a/SBS7b | UV radiation (melanoma) | paper:DiazGay2023, paper:Miura2022, paper:Zhang2026a |
...
explicit unattributed residual channel in paper:Zhang2026a (SigFormer) is a design feature that

---
id: "hypothesis:h01-non-tumor-signal-contamination"
type: "hypothesis"
...
- **Sibling hypotheses:** `hypothesis:h05-healthy-somatic-background-atlas` (the
  cross-individual, cross-tissue, cross-age generalization of the "normal background"
  notion); `hypothesis:h02-cross-study-ranking-divergence-is-structured` (methodological

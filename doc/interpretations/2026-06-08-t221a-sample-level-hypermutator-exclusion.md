---
id: "interpretation:2026-06-08-t221a-sample-level-hypermutator-exclusion"
type: "interpretation"
title: "t221(a): the full-WES neural-gene residual is NOT a hypermutator artifact — a sample-level exclusion across all 91 WES studies (326 hypermutator samples, 1.15M variant rows dropped) leaves the genomic-span residual exactly where it was (span-matched p 0.002 -> 0.002)"
status: "active"
related:
...
`h12`; the project entities `hypothesis:h12` (proposed) and `question:q032` (active) are left in their

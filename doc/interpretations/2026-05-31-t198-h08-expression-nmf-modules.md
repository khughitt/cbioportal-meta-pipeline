...
(`pre-registration:h08-positive-control` § Total Comparison Count, as clarified by Amendment
...
`pre-registration:h08-positive-control` **Amendment 001** (`amendment_before_results`): realized

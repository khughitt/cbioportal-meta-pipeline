...
A repaired Arm-B primary pass requires all of the following, exactly as committed in `pre-registration:0004-h08-smoking-arm-repair-repaired-smoking-covariate-must-recover-sbs4`:

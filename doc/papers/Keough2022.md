...
- **In vivo optogenetics:** cortical neuron stimulation in glioma xenograft mouse models (Venkatesh 2015, 2019); optic pathway glioma models with visual deprivation (Pan 2021).
...
- **Patch-clamp electrophysiology:** recordings from glioma cells in situ demonstrating fast (<5 ms) AMPAR-mediated postsynaptic currents spontaneously and evoked by neuronal stimulation (Venkataramani 2019, Venkatesh 2019).
...
| NLGN3 expression inversely correlates with GBM survival | Driver gene annotation layer (`bailey2018_driver`-equivalent; NLGN3 not in Bailey 2018 driver list) |
...
- Primary experimental data are in the cited primary papers (Venkatesh 2015, 2017, 2019; Venkataramani 2019; Pan 2021; Zeng 2019; Magnon 2013; Renz 2018a,b; Hayakawa 2017).
...
7. **Literature bridge to Venkatesh 2019** (cited extensively here) — if a paper summary for Venkatesh2019 is in the batch, that paper provides the primary experimental data underlying the synaptic integration mechanism reviewed here.

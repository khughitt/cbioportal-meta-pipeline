...
`hypothesis:h06-pre-malignant-n-minus-1-driver-carriage` is in `phase: candidate`. No
...
The inverse question `question:q012-mutation-ordering-cross-sectional-inference` flags a
...
`hypothesis:h06-pre-malignant-n-minus-1-driver-carriage` was formalized on 2026-04-27/28
as a complement to the sibling hypothesis `hypothesis:h04-mhn-pathway-ordering`, which
shares `question:q012-mutation-ordering-cross-sectional-inference` as a non-primary link.

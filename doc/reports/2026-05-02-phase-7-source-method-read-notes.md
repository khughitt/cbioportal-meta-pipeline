---
id: "report:2026-05-02-phase-7-source-method-read-notes"
type: "report"
...
`hypothesis:h04-mhn-pathway-ordering` proposes that Mutual Hazard Networks (MHN),
...
`question:q012-mutation-ordering-cross-sectional-inference` asks whether directed

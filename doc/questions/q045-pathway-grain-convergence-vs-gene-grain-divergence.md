---
id: "question:q045-pathway-grain-convergence-vs-gene-grain-divergence"
type: "question"
title: "Does the cancer-type specificity of drivers seen at the gene level collapse at pathway grain — i.e. do cancer types converge on shared pathways even when they diverge on which gene is hit?"
status: "active"
ontology_terms:
  - convergence
...
datasets:
  ...
  - "gene->pathway map (external — Reactome / KEGG / Sanchez-Vega 10 canonical pathways; not yet vendored)"
source_refs:
  - "paper:Kauko2025"
...
- **Shared substrate:** `topic:co-occurrence-and-mutual-exclusivity` / `t078`, `h04` (pathway ordering),
  `q043` (the driver roster), `theme:temporal-structure-of-carcinogenesis`.

...
ontology_terms:
  ...
  - "metastasis"
datasets:
  - "MSK-MET (n=25,775; primary + metastatic; downloaded from cBioPortal)"
source_refs:
  - "cite:Deshpande2026"
related:
...
dataset_usage:
  - ref: "dataset:msk-met"
    role: "analyzed"
    overlap: "partial — MSK-IMPACT panel is cBioPortal-hosted; overlaps with individual MSK studies in this project"
---
...
Fifteen hallmarks from Hanahan 2022 (*Cancer Discovery*) were used:
...
| 11 attractor states (EO/HRM model) | Data-driven cancer subgroups beyond histology | These are states, not a progression order; contrast with h04 MHN ordering goal |
...
| Bootstrap + 5-fold CV robustness evaluation | Leave-one-study-out stability (h04 falsifiability) | Directly adoptable validation protocol for any clustering step in the project |
...
| No progression ordering claimed | h04 MHN pathway ordering | Paper is about states/structure; ordering is an open question that this paper neither addresses nor contradicts |

---
id: theme:temporal-structure-of-carcinogenesis
type: theme
title: Temporal structure of carcinogenesis — order, count, and timing of the events of cancer
status: active
...
- **Order** — in what *sequence* are drivers/pathways acquired? (`question:q012`, `hypothesis:h04`
  MHN ordering; `hypothesis:h06` pre-malignant n-1 carriage as the paired-data route; the
  hallmark-grain echo in `discussion:2026-06-07-hallmark-ordering-and-data-driven-modules`).
- **Count** — *how many* rate-limiting events does a cancer type require, and how does that set its
  age of onset? (`topic:multistage-carcinogenesis-and-age-of-onset`, `question:q041`).

...
In paper:Luo2023, 47 non-artefact signatures are collapsed into 13 labelled etiology groups:
...
- **UV / SBS7 (SKCM):** UV signature activity is associated with lymphocyte and T-cell
  infiltration in skin melanoma (paper:Luo2023) and enriches for RTK-RAS driver mutations
...
- **Tobacco / SBS4 (LUAD/LUSC):** Tobacco signature is synergistic with immune infiltration for
  survival in LUAD (paper:Luo2023); high myeloid/lymphocyte/T-cell infiltration prolongs
...
- **APOBEC / SBS2-SBS13:** APOBEC (AID/APOBEC etiology) is associated with immune cell types
  ...
  paper:Luo2023 map. In paper:Hakobyan2024, APOBEC interacts positively with HRD signatures in
...
- **dMMR / MSI-H:** MMR-deficiency signatures associate with neoantigen burden and immune
  infiltration across CRC, STAD, UCEC, and several other cancer types (paper:Luo2023). In
...
26+ of 32 cancer types and 17 of 21 cell types in paper:Luo2023 — a wider span than any
...
HNSC and BLAC (paper:Luo2023). The mechanism underlying this sign reversal is unknown
...
paper:Luo2023 collapses 47 signatures into 13 etiology groups to gain statistical power and
...
**Positive-control grounding.** The pan-cancer evidence in paper:Luo2023 and the
...
primary covariate. paper:Hakobyan2024's within-tissue bootstrapped null and paper:Luo2023's
...
(antagonistic in LUAD, synergistic in HNSC/BLAC) identified by paper:Luo2023 is testable in

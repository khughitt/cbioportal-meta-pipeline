---
id: hypothesis:h10-treatment-induced-signature-frequency-contamination
type: hypothesis
...
aggregated frequency tables. This is the signature-era refinement of `hypothesis:h01`
...
- The pipeline already has a hypermutator/TMB annotation layer; adding a treatment-exposed stratum
  (`question:q024`, `task:t181`) makes this directly testable against the existing frequency outputs.
...
- Hypotheses: `hypothesis:h01-non-tumor-signal-contamination` (contamination lineage),

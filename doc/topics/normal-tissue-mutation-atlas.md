...
type: "topic"
title: "Normal-tissue somatic-mutation atlas: cross-tissue, cross-age background as positive knowledge"
status: "active"
ontology_terms:
  - somatic mutation
  - normal tissue
...
source_refs:
  ...
  - "paper:Yoshida2026"
related:
  - "hypothesis:h05-healthy-somatic-background-atlas"
...
- **Direct support for `hypothesis:h05`** (cross-tissue normal background atlas + the
  null-substitution claim).
- **Sibling support for `hypothesis:h01`** (within-sample non-tumor signal contamination

...
and the technical harmonization pipeline that later releases continue to follow [@AACRGENIEConsortium2017].
...
enumerated in the main text [@AACRGENIEConsortium2017]. <!-- UNVERIFIED: specific panel-to-center mapping beyond size class -->
...
~2,200 breast, and melanoma (n=785), with 12+ additional tumor types [@AACRGENIEConsortium2017].
...
much lower rates in renal, prostate, and pancreatic cancer [@AACRGENIEConsortium2017].
...
post-TKI resistance population [@AACRGENIEConsortium2017].
...
concordant with observed NCI-MATCH accrual (P < 10⁻⁴) [@AACRGENIEConsortium2017].
...
difference in detection opportunity for the same gene) [@AACRGENIEConsortium2017].

...
Next step: run the WP4 impact pass on the configured substrate and write the t207 interpretation note, keeping the exposure-label result separate from the q027 therapy-signature-high arm.

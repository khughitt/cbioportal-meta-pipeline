...
- `paper:Luo2023a` finds clock-like SBS40 has the broadest TME impact but aggregates it into a single clock-like etiology group, not separating SBS40 from SBS5.
...
- Major uncertainty: identifiability of the expression->H edge (reverse causation R2 in the method DAG) — see `question:0025`.
...
- Article notes: `paper:Hakobyan2024`, `paper:Luo2023a`, `paper:Spisak2025`
- Methods/Datasets: `method:h08-agnostic-association-model`; `question:0025`

...
ontology_terms:
  ...
  - pan-cancer
datasets:
  - "TCGA (16 cancer types with matched adjacent-normal tissue)"
  - "GTEx v8 (26 human tissues, normal tissue expression reference)"
source_refs:
  - "cite:dosSantos2023"
related:
...
`question:q042-driver-normal-expression-tissue-cell-type-specificity`. Because tumors
...
from `hypothesis:h12-neural-gene-enrichment-length-histology-artifact` (that ectopic

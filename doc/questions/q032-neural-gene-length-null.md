---
id: "question:q032-neural-gene-length-null"
type: "question"
title: "Does the apparent neural-gene enrichment in top-mutated genes survive gene-length normalization, or is it a length artifact?"
status: "active"
ontology_terms:
  - gene length
  - somatic mutation
...
- Decides whether there is *anything to explain*. If the enrichment is pure length, H1/H3
  interpretation is moot and the observation is a known artifact (`hypothesis:h03`).
...
- Best current interpretation: most of the signal is length (P1 of `hypothesis:h12`).

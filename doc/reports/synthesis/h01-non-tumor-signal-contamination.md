...
question:q006-ch-priority-gene-completeness asks whether that panel is sufficient to capture
...
question:q004-mca-burden-in-esophageal-vs-other-study-tissues, and
question:q005-gli1-normal-tissue-hotspot-inflation — remains entirely unaddressed by internal
analysis. The null-model questions (question:q007-cross-tissue-somatic-mutation-rate-variation-as-null-model,
question:q008-signature-decomposition-tissue-background-subtraction,
question:q010-cuplr-style-tof-classifier-for-suspect-normal-samples) have infrastructure
...
One negative result constrains the SBS1 channel: interpretation:2026-04-22-t110-sbs1-sbs5-brca-comparison
...
simple SBS1/SBS5 ratio as a thresholdable flag for question:q008-signature-decomposition-tissue-background-subtraction. The comparison was further
...
The first documented move, recorded in interpretation:2026-04-19-t111-normal-tissue-spectra-pipeline,
...
unblock question:q007-cross-tissue-somatic-mutation-rate-variation-as-null-model, question:q008-signature-decomposition-tissue-background-subtraction, and question:q010-cuplr-style-tof-classifier-for-suspect-normal-samples at the infrastructure level but
deliberately deferred all analytic correction work; no cBioPortal output has been corrected
against the baseline.

The second documented move, interpretation:2026-04-22-t110-sbs1-sbs5-brca-comparison, tested
...
- task:t127 (blocked, P3) is the designated first quantitative pass for
  question:q008-signature-decomposition-tissue-background-subtraction — per-gene rate
...
- task:t114 (proposed, P2) would pre-register the question:q007-cross-tissue-somatic-mutation-rate-variation-as-null-model
...
- task:t153 (proposed, P2) would annotate CFS locus overlap and run RT-vs-CFS residual
  regression to test question:q014-cfs-as-distinct-confounder-class.
...
- task:t164 (proposed, P2) would draft candidate hypothesis h07 absorbing the
  signature/topography QC path (question:q010-cuplr-style-tof-classifier-for-suspect-normal-samples).

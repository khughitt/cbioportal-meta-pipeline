---
id: "discussion:2026-06-07-hallmark-ordering-and-data-driven-modules"
type: "discussion"
title: "Is there a preferred ordering among the hallmarks of cancer — and can the hallmarks themselves be inferred from data rather than human labels?"
status: "active"
source_refs:
  - "paper:Gourmet2024"
...
updated: "2026-06-07"
focus_type: "approach"
focus_ref: "ordering of cancer hallmarks; data-driven (label-free) inference of hallmark-like mutation modules"
mode: "standard"
---
...
work (`question:q012`, `hypothesis:h04`):
...
(`question:q012`, `t133` VAF audit, `t055` deferred CNA) — so even this prior art's
...
This result is, at the hallmark grain, the same claim `hypothesis:h04` makes at the

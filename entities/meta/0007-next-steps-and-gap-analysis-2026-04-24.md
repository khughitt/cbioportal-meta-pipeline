...
created: '2026-04-24'
updated: '2026-04-24'
id: meta:0007-next-steps-and-gap-analysis-2026-04-24
---
...
- **`q009` replication-timing pilot ran to a fork.** `t121` (constitutive RT gene map from Dileep et al. [@Dileep2015]), `t122` (all-mutation CE/CL burden), and `t123` (SBS1-proxy CE/CL burden) landed with three interpretation documents. `t122` was suggestive but coverage-confounded; `t123` collapsed under panel zero-inflation (only 58/1,210 unmatched samples had any proxy mutation at all).

---
id: interpretation:2026-06-01-t207-h10-treatment-impact-target-blocked-by-missing-full-config-raw
type: interpretation
...
Superseded by `interpretation:2026-06-01-t207-h10-treatment-impact-full-config`.
...
This result is not confirmatory evidence for or against `hypothesis:h10-treatment-induced-signature-frequency-contamination`.
...
`hypothesis:h10-treatment-induced-signature-frequency-contamination` remains proposed and empirically unresolved.
...
`question:q024-treatment-exposed-cohort-chemotherapy-signature` is partially affected.
...
`question:q027-does-excluding-treatment-signature-high-samples` is unchanged.

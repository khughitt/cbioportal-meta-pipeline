...
Next step: implement WP4 impact aggregation over the per-study H10 treatment views, including `delta_no_detected_contrast`, `delta_mutagenic_primary`, rank shifts, and contrast-specific power statuses.

---
id: synthesis:h10-treatment-induced-signature-frequency-contamination
type: synthesis
...
hypothesis:h10-treatment-induced-signature-frequency-contamination proposes that treated/relapsed
...
(interpretation:2026-06-01-t206-treatment-exposure-audit) identified 11 broad treatment-exposed
...
(interpretation:2026-06-01-t207-h10-treatment-impact-full-config) covers 383,477 samples across 198
...
driver-frequency inflation (interpretation:2026-06-01-t208-h10-sample-level-mutagenic-rules).

The measured-signature arm (question:q027-does-excluding-treatment-signature-high-samples) found 36
...
(interpretation:2026-06-01-t210-q027-therapy-signature-high-exclusion). A broad substrate scan of
all 198 configured studies confirmed no second adequate patient cohort exists in the current
configured substrate (interpretation:2026-06-01-t211-q027-substrate-discovery).
...
question:q024-treatment-exposed-cohort-chemotherapy-signature without yet testing h10
(interpretation:2026-06-01-t181-treatment-exposure-stratum).
...
(interpretation:2026-06-01-t206-treatment-exposure-audit). t207 attempted a full-config run, was
...
(interpretation:2026-06-01-t207-h10-treatment-impact-full-config). t208 added deterministic
...
GLASS blank-TMZ samples (interpretation:2026-06-01-t208-h10-sample-level-mutagenic-rules). t209
...
(interpretation:2026-06-01-t209-h10-sample-level-unknown-naive-rules).

The investigation then branched to the measured-signature arm. t210 ran the distinct
question:q027-does-excluding-treatment-signature-high-samples arm against measured SBS11/SBS31/
...
(interpretation:2026-06-01-t210-q027-therapy-signature-high-exclusion). t211 broadened the
...
(interpretation:2026-06-01-t211-q027-substrate-discovery). The current epistemic position is that
...
**Live questions.** question:q024-treatment-exposed-cohort-chemotherapy-signature is partially
...
question:q027-does-excluding-treatment-signature-high-samples is technically answered for GLASS but
...
**Next investigative options** (from interpretation:2026-06-01-t211-q027-substrate-discovery and
interpretation:2026-06-01-t210-q027-therapy-signature-high-exclusion):

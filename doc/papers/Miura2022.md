...
- The convergent smoking→APOBEC signature shift observed here is consistent with an immune-pressure / selection mechanism discussed in `discussion:2026-05-30-common-mutational-signatures-known-vs-learned-immune-causes-and-confounding` (immune editing removing high-TMB clones, leaving APOBEC-diversified clones). Explicit testing of this hypothesis requires immune cell abundance data alongside the signature dynamics.

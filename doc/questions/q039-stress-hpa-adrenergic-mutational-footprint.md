---
id: "question:q039-stress-hpa-adrenergic-mutational-footprint"
type: "question"
title: "Does chronic adrenergic / glucocorticoid (stress-HPA) signaling leave a detectable mutational-signature or TMB footprint, via DNA-repair suppression?"
status: "active"
ontology_terms:
  - stress signaling
  - HPA axis
...
- Major uncertainty: no direct stress covariate in cBioPortal; would need a proxy (e.g.
  beta-blocker exposure as inverse proxy — see `question:q040`) or an external EHR-rich substrate.

...
Next step: implement WP3 treatment-aware per-study frequency views using `samples_treatment_exposure.feather`, preserving the existing hypermutator `_inclusive` / `_exclusive` contract.

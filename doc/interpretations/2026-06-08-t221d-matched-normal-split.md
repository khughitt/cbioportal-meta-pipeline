---
id: "interpretation:2026-06-08-t221d-matched-normal-split"
type: "interpretation"
title: "t221(d): a true study-level matched- vs unmatched-normal split confirms germline leak is not the candidate driver — within call-set-region stratum the residual is identical across normal status (all-region matched p 0.0000 vs unmatched 0.0006; both exonic arms null), and the biggest single residual-carrier (pog570) is matched-normal"
status: "active"
related:
...
**candidate-set mutational-count thread** of `h12`; `hypothesis:h12` (proposed) and `question:q032` (active)

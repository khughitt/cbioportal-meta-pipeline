---
id: "pre-registration:h08-smoking-repair"
type: "pre-registration"
title: "h08 smoking-arm repair — repaired smoking covariate must recover SBS4 without rereading the locked H08a verdict"
status: "committed"
...
This is **not** an amendment that rereads the frozen `pre-registration:h08-positive-control` result.

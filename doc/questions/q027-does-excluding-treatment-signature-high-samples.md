---
id: question:q027-does-excluding-treatment-signature-high-samples
type: question
...
The impact test for `hypothesis:h10`. After flagging therapy-signature-high samples (SBS11/31/35/87), re-run the pooled gene × cancer frequency tables with and without them and measure whether the deliverable — and any cross-study driver ranking — changes beyond noise.

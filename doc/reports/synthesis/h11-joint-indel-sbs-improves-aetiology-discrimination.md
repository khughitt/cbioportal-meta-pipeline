---
id: "synthesis:h11-joint-indel-sbs-improves-aetiology-discrimination"
type: "synthesis"
...
`hypothesis:h11-joint-indel-sbs-improves-aetiology-discrimination` is **proposed** with no
...
usable depth — is unanswered; `question:q028-indel-call-availability-across-cbioportal-studies`
...
`question:q020-minimum-sample-size-and-caller-provenance-for`, but whether those thresholds
...
- `question:q028-indel-call-availability-across-cbioportal-studies` — What fraction of
...
- `question:q020-minimum-sample-size-and-caller-provenance-for` — Minimum sample-size and
...
- `t188` (P3, proposed) — Census indel-call availability across the cBioPortal/MC3 corpus;
  ...
  `question:q028-indel-call-availability-across-cbioportal-studies`.

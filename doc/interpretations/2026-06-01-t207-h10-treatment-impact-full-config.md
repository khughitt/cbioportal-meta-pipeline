---
id: interpretation:2026-06-01-t207-h10-treatment-impact-full-config
type: interpretation
...
prior_interpretations:
  ...
  - interpretation:2026-06-01-t207-h10-treatment-impact-target-blocked-by-missing-full-config-raw
relations:
  - predicate: "sci:supersedes"
    target: "interpretation:2026-06-01-t207-h10-treatment-impact-target-blocked-by-missing-full-config-raw"
---
...
`question:q024-treatment-exposed-cohort-chemotherapy-signature` advances from audit-only to executable exposure-label substrate.
...
`hypothesis:h10-treatment-induced-signature-frequency-contamination` remains proposed and unresolved.

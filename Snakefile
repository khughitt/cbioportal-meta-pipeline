...
rule all:
  input:
    expand(out_dir.joinpath("{id}/freq/cancer.feather"), id=ids),
    expand(out_dir.joinpath("{id}/freq/cancer_detailed.feather"), id=ids),
    expand(out_dir.joinpath("{id}/freq/gene.feather"), id=ids),

...
- `paper:Jiang2025a` shows consensus calling (>=2 callers) is essential for artefact-free de novo SBS extraction; single callers inject reproducible spurious signatures.

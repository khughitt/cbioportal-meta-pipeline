---
id: hypothesis:h11-joint-indel-sbs-improves-aetiology-discrimination
type: hypothesis
...
- **status: proposed.** Lower priority than h09/h10 (depends on indel-call availability across the
  corpus, which is `question:q020` territory). Belongs to the `signature-modality-expansion` task
  group.

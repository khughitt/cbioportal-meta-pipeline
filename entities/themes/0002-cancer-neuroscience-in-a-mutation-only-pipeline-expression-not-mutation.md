...
created: '2026-06-07'
updated: '2026-06-07'
id: theme:0002-cancer-neuroscience-in-a-mutation-only-pipeline-expression-not-mutation
...
- question:0039-stress-hpa-adrenergic-mutational-footprint
...
(21-paper batch, `synthesis:0015-cancer-neuroscience-literature-batch-21-papers-does-it-explain-a-neural`). The field's biology — neural
...
- **Outside (remains its own concept/work):** building an expression modality (a scope decision
  ...
  (`theme:0001-assay-regime-panel-wes-wgs-as-a-master-technical-confounder-spanning`) which is technical, not biological.
